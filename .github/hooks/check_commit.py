#!/usr/bin/env python3
"""GitHub Copilot — PreToolUse (shell): valida la commit convention (S12).
...
Contratto Copilot: payload JSON su stdin (tool_input.command). Per bloccare esce
2 con la motivazione su stderr (fail-closed).
"""
import json
import re
import shlex
